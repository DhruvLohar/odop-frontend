...
const Page = () => {
    const [cartItems, setCartItems] = useState([
        { id: 1, name: 'WoodenCraft', price: 56, quantity: 1, seller: 'Mr. John Doe',image: "/districtArtisanImage1.png" },
        { id: 2, name: 'SteelCraft', price: 44, quantity: 1, seller: 'Mr. Sahil Doe',image: "/districtArtisanImage2.png" },
    ]);
        ...
        <>
            <main className='flex min-h-screen md:min-w-full md:w-3/5 md:px-4 px-5 flex-col md:flex-row mb-14'>
                <div className='w-full top-0 md:w-1/2 md:mt-0 md:mr-5'>
                    ...
                    <div className="cart-details">
                        {cartItems.length === 0 ? (
                            ...
                            cartItems.map((item) => (
                                <div key={item.id} className="w-full flex items-start lg:mb-12 lg:flex-row lg:justify-center flex-col">
                                    ...
                                    <div className="px-1 w-full md:w-auto flex flex-row mb-6 md:flex-col justify-between md:mt-0 mt-2 lg:ml-auto">
                                        ...
                                        <div className='flex justify-center items-center '>
                                            <h1 className='cursor-pointer' onClick={() => handleQuantityChange(item.id, -1)}>-</h1>
                ...
                <div className="w-full md:w-1/3 md:pl-10 mt-12 md:mt-0 justify-start gap-10 flex flex-col">
                    ...
                    <div className={`w-full h-16 rounded-full flex justify-center items-center ${cartItems.length === 0 ? 'bg-gray-400 cursor-not-allowed' : 'bg-black hover:bg-gray-700'}`}>
